        ...
        <div class="col-4">
          <div class="card bg-light" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <p class="card-text">${product.description.length > 100 ? product.description.substr(0, 100) + "..." : product.description}
              </p>
              <button href="./detail.html?id=${product.id} class="btn">Buy Now</button>
